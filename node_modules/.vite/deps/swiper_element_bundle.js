//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/shared/utils.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/shared/swiper-core.mjs
var supportCached;
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/shared/update-swiper.mjs
var paramsList = [
	"eventsPrefix",
	"injectStyles",
	"injectStylesUrls",
...
function updateSwiper(args) {
	...
	if (changedParams.includes("thumbs") && isObject(passedThumbs) && isObject(passedThumbs.swiper) && !passedThumbs.swiper.destroyed && isObject(currentThumbs) && (!currentThumbs.swiper || currentThumbs.swiper.destroyed)) needThumbsInit = true;
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/shared/get-element-params.mjs
var formatValue = (val) => {
	...
	if (val.includes("{") && val.includes("}") && val.includes("\"")) try {
...
function getParams(element, propName, propValue) {
	...
	localParamsList.forEach((rawName) => {
		...
		if (typeof element[paramName] !== "undefined") passedParams[paramName] = element[paramName];
	});
	const attrsList = [...element.attributes];
	if (typeof propName === "string" && typeof propValue !== "undefined") attrsList.push({
		name: propName,
	...
	attrsList.forEach((attr) => {
		...
		if (moduleParam) {
			...
			if (passedParams[parentObjName] === true) passedParams[parentObjName] = { enabled: true };
			if (passedParams[parentObjName] === false) passedParams[parentObjName] = { enabled: false };
			...
			if (existing && modulesParamsList.includes(attr.name) && !isObject(value)) {
				const existingObj = isObject(existing) ? existing : {};
				existingObj.enabled = !!value;
				passedParams[name] = existingObj;
			} else passedParams[name] = value;
		}
	});
	extend(params, passedParams);
	if (params.navigation) params.navigation = {
		prevEl: ".swiper-button-prev",
		nextEl: ".swiper-button-next",
		...params.navigation !== true ? params.navigation : {}
	};
	else if (params.navigation === false) delete params.navigation;
	if (params.scrollbar) params.scrollbar = {
		el: ".swiper-scrollbar",
		...params.scrollbar !== true ? params.scrollbar : {}
	};
	else if (params.scrollbar === false) delete params.scrollbar;
	if (params.pagination) params.pagination = {
		el: ".swiper-pagination",
		...params.pagination !== true ? params.pagination : {}
	};
	else if (params.pagination === false) delete params.pagination;
	return {
		params,
		passedParams
	};
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/virtual.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/keyboard.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/mousewheel.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/shared/create-element-if-not-defined.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/navigation.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/shared/classes-to-selector.mjs
function classesToSelector(classes = "") {
	return `.${classes.trim().replace(/([.:!+/()[\]#>~*^$|=,'"@{}\\])/g, "\\$1").replace(/ /g, ".")}`;
}
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/pagination.mjs
...
var Pagination = ({ swiper, extendParams, on, emit }) => {
	...
	function update() {
		...
		let current;
		let previousIndex;
		const slidesLength = isVirtualEnabled$2(swiper) ? swiper.virtual.slides.length : swiper.slides.length;
	...
	function render() {
		...
		const slidesLength = isVirtualEnabled$2(swiper) ? swiper.virtual.slides.length : swiper.grid && gridParams?.rows && gridParams.rows > 1 ? swiper.slides.length / Math.ceil(gridParams.rows) : swiper.slides.length;
		const els = makeElementsArray(swiper.pagination.el);
		let paginationHTML = "";
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/scrollbar.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/parallax.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/zoom.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/controller.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/a11y.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/history.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/hash-navigation.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/autoplay.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/thumbs.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/free-mode.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/grid.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/manipulation.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/shared/effect-init.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/shared/effect-target.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/shared/effect-virtual-transition-end.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/effect-fade.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/effect-cube.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/shared/create-shadow.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/effect-flip.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/effect-coverflow.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/effect-creative.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/modules/effect-cards.mjs
...
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/swiper-bundle.mjs
/**
* Swiper 14.0.1
...
Swiper.use(modules);
//#endregion
//#region node_modules/.pnpm/swiper@14.0.1/node_modules/swiper/swiper-element-bundle.mjs
/**
...
var SwiperContainer = class extends ClassToExtend {
	...
	calcSlideSlots() {
		...
		if (this.slideSlots > currentSideSlots) for (let i = currentSideSlots; i < this.slideSlots; i += 1) {
			...
			for (let i = slides.length - 1; i >= 0; i -= 1) if (i > this.slideSlots) slides[i].remove();
		}
	}
	render() {
		if (this.rendered) return;
		...
		if (this.slideSlots > 0) localStyles = localStyles.replace(/::slotted\(([a-z-0-9.]*)\)/g, "$1");
		if (localStyles.length) addStyle(this.shadowRoot, localStyles);
		this.cssLinks().forEach((url) => {
			if (this.shadowRoot.querySelector(`link[href="${url}"]`)) return;
	...
	initialize() {
		...
		this.swiper = new Swiper(this.shadowRoot.querySelector(".swiper"), {
			...
			onAny: (name, ...args) => {
				if (name === "observerUpdate") this.calcSlideSlots();
	...
	connectedCallback() {
		...
		if (this.swiper && this.swiper.initialized && this.nested && slideParent && slideParent.swiperLoopMoveDOM) return;
		if (this.init === false || this.getAttribute("init") === "false") return;
		this.initialize();
	}
	disconnectedCallback() {
		const slideParent = this.closest("swiper-slide");
		if (this.nested && slideParent && slideParent.swiperLoopMoveDOM) return;
	...
	updateSwiperOnPropChange(propName, propValue) {
		...
		this.passedParams = passedParams;
		this.swiperParams = swiperParams;
		if (this.swiper && this.swiper.params[propName] === propValue) return;
		updateSwiper({
			swiper: this.swiper,
			...
			...propName === "pagination" && passedParams[propName] ? { paginationEl: ".swiper-pagination" } : {},
			...propName === "scrollbar" && passedParams[propName] ? { scrollbarEl: ".swiper-scrollbar" } : {}
		});
	}
	attributeChangedCallback(attr, prevValue, newValue) {
		if (!(this.swiper && this.swiper.initialized)) return;
		let nextValue = newValue;
		if (prevValue === "true" && newValue === null) nextValue = false;
...
var SwiperSlide = class extends ClassToExtend {
	...
	connectedCallback() {
		if (this.swiperLoopMoveDOM) return;
		this.initialize();
	}
};
var register = () => {
...
if (typeof window !== "undefined") window.SwiperElementRegisterParams = (params) => {
